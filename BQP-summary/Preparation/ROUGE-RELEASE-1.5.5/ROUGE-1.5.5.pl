...
#              (1) smart_common_words_english.txt - contains stopword list from SMART IR engine
...
if(defined($opt_e)) {
  $stopwords="$opt_e/smart_common_words_english.txt";
  $wordnetDB="$opt_e/WordNet-2.0.exc.db";
}
else {
  if(exists($ENV{"ROUGE_EVAL_HOME"})) {
    $stopwords="$ENV{\"ROUGE_EVAL_HOME\"}/smart_common_words_english.txt";
    $wordnetDB="$ENV{\"ROUGE_EVAL_HOME\"}/WordNet-2.0.exc.db";
  }
  elsif(exists($ENV{"RED_EVAL_HOME"})) {
    $stopwords="$ENV{\"RED_EVAL_HOME\"}/smart_common_words_english.txt";
    ...
    $stopwords="smart_common_words_english.txt";
